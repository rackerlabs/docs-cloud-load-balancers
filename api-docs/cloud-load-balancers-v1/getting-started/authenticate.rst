...
request with valid account credentials to the following Rackspace Cloud
...
.. note::
     ...
     - :rax-devdocs:`Authentication token operations
       <cloud-identity/v2/developer-guide/#document-api-operations/
       token-operations>`
     ...
     - :rax-devdocs:`Manage tokens and token expiration <cloud-identity/
