...
+--------------+---------------------------------------------------------------------+
| SSL_ID       | A session persistence mechanism which sends all SSL traffic with    |
...
.. include:: methods/delete-disable-session-persistence-v1.0-account-loadbalancers-loadbalancerid-sessionpersistence.rst
