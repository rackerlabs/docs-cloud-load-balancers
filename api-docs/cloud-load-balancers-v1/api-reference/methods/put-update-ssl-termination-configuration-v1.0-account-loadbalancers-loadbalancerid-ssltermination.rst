...
**Example Update Load Balancing SSL Termination Full Certification Response: XML**

.. code::


    <sslTermination xmlns="http://docs.openstack.org/loadbalancers/api/v1.0" xmlns:atom="http://www.w3.org/2005/Atom" enabled="true" securePort="500" secureTrafficOnly="false" cipherProfile="default">
        <certificate>-----BEGIN CERTIFICATE-----
    MIIEWjCCA0KgAwIBAgIGATTTGu/tMA0GCSqGSIb3DQEBBQUAMHkxCzAJBgNVBAYT
    AlVTMQ4wDAYDVQQIEwVUZXhhczEOMAwGA1UEBxMFVGV4YXMxGjAYBgNVBAoTEVJh
    Y2tTcGFjZSBIb3N0aW5nMRQwEgYDVQQLEwtSYWNrRXhwIENBNTEYMBYGA1UEAxMP
    ...
    -----END CERTIFICATE-----</intermediateCertificate>
        <securityProtocols>
            <securityProtocol securityProtocolName="TLS_10" securityProtocolStatus="ENABLED"/>
            <securityProtocol securityProtocolName="TLS_11" securityProtocolStatus="ENABLED"/>
        </securityProtocols>
    </sslTermination>
...
**Example Update Load Balancing SSL Termination Attribute Response: XML**

.. code::

        <?xml version="1.0" encoding="UTF-8" standalone="yes"?>
    <sslTermination xmlns="http://docs.openstack.org/loadbalancers/api/v1.0" xmlns:atom="http://www.w3.org/2005/Atom" enabled="true" securePort="443" secureTrafficOnly="true" cipherProfile="default">
        <certificate>-----BEGIN CERTIFICATE-----
    MIIEWjCCA0KgAwIBAgIGATTTGu/tMA0GCSqGSIb3DQEBBQUAMHkxCzAJBgNVBAYT
    AlVTMQ4wDAYDVQQIEwVUZXhhczEOMAwGA1UEBxMFVGV4YXMxGjAYBgNVBAoTEVJh
    Y2tTcGFjZSBIb3N0aW5nMRQwEgYDVQQLEwtSYWNrRXhwIENBNTEYMBYGA1UEAxMP
...
**Example Update Load Balancing SSL Termination Attribute Response: JSON**
...
**Example Update Load Balancing SSL Termination to Disable TLS 1.0 on an New SSL Termination Configuration Response: XML**

.. code::

        <?xml version="1.0" encoding="UTF-8" standalone="yes"?>
    <sslTermination xmlns="http://docs.openstack.org/loadbalancers/api/v1.0" xmlns:atom="http://www.w3.org/2005/Atom" enabled="true" securePort="443" secureTrafficOnly="false" cipherProfile="default">
        <certificate>-----BEGIN CERTIFICATE-----
    MIIGkTCCBHmgAwIBAgIGAVVWR2MaMA0GCSqGSIb3DQEBCwUAMHoxDDAKBgNVBAMT
    A0lNRDEbMBkGA1UECxMSQ2xvdWQgTG9hZEJhbGFuY2VyMRowGAYDVQQKExFSYWNr
    c3BhY2UgSG9zdGluZzEUMBIGA1UEBxMLU2FuIEFudG9uaW8xDjAMBgNVBAgTBVRl
...
**Example Update Load Balancing SSL Termination to Disable TLS 1.0 on an New
SSL Termination Configuration Response: JSON**
...
**Example Update Load Balancing SSL Termination to Disable TLS 1.0 on an
Existing SSL Termination Configuration Response: XML**
...
**Example Update Load Balancing SSL Termination to Disable TLS 1.0 on an
Existing SSL Termination Configuration Response: JSON**
