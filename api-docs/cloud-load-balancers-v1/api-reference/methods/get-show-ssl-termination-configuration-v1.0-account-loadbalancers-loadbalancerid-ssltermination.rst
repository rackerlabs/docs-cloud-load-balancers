...
.. code::
    ...
    <sslTermination xmlns="http://docs.openstack.org/loadbalancers/api/v1.0" enabled="true" securePort="500" secureTrafficOnly="false" cipherProfile="default">
    ...
    <securityProtocols>
        ...
        <securityProtocol securityProtocolName="TLS_11" securityProtocolStatus="DISABLED"/>
    </securityProtocols>
    </sslTermination>
