...
html_title = 'Rackspace Cloud Load Balancers v2 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Load Balancers v2 API'
...
htmlhelp_basename = 'docs-cloud-load-balancers'
...
latex_documents = [
  (master_doc, 'docs-cloud-load-balancers.tex',
   'Rackspace Cloud Load Balancers API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Cloud Load Balancers API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-load-balancers',
   ...
   'Learn about using the Cloud Load Balancers',
   'Miscellaneous'),
]
