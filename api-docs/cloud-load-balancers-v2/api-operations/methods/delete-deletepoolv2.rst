...
tenant account. Any and all configuration data is immediately purged and
cannot be recovered.

You cannot delete a pool if the load balancer to which it is attached
does not have a ``provisioning_status`` of ``ACTIVE``.
