...
`Request <GET_show_load_balancer_details_v1.0_account_loadbalancers_loadbalancerid_.rst#request>`__
`Response <GET_show_load_balancer_details_v1.0_account_loadbalancers_loadbalancerid_.rst#response>`__
...
**Example Show Load Balancer Details: JSON request**
...
**Example Show Load Balancer Details: XML request**
