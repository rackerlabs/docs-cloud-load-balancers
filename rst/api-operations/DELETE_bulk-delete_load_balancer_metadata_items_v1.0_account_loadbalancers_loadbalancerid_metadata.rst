...
`Request <DELETE_bulk-delete_load_balancer_metadata_items_v1.0_account_loadbalancers_loadbalancerid_metadata.rst#request>`__
`Response <DELETE_bulk-delete_load_balancer_metadata_items_v1.0_account_loadbalancers_loadbalancerid_metadata.rst#response>`__
