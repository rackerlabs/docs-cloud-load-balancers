...
`Request <post-add-load-balancer-metadata-v1.0-account-loadbalancers-loadbalancerid-metadata.html#request>`__
`Response <post-add-load-balancer-metadata-v1.0-account-loadbalancers-loadbalancerid-metadata.html#response>`__
