...
`Request <POST_add_certificate_mapping_v1.0_account_loadbalancers_loadbalancerid_ssltermination_certificatemappings.rst#request>`__
`Response <POST_add_certificate_mapping_v1.0_account_loadbalancers_loadbalancerid_ssltermination_certificatemappings.rst#response>`__
...
When a certificate mapping is added, it is assigned a unique ID that can be used for management operations such as changing its attributes or removing it.
