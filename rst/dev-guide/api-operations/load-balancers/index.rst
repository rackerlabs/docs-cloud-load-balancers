...
.. toctree::
    ...
    List load balancers <GET_list_load_balancers_v1.0_account_loadbalancers>
    Create load balancer <POST_create_load_balancer_v1.0_account_loadbalancers>
    Bulk-delete load balancer <DELETE_bulk-delete_load_balancers_v1.0_account_loadbalancers>
    Show load balancer details <GET_show_load_balancer_details_v1.0_account_loadbalancers_loadbalancerid>
    Update load balancer properties <PUT_update_load_balancer_properties_v1.0_account_loadbalancers_loadbalancerid>